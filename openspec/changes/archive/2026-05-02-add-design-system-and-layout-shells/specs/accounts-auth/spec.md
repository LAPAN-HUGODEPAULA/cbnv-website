...
As telas de área do autor e revisor SHALL herdar de `templates/layouts/dashboard.html`, fornecendo uma interface de navegação focada em tarefas, separada do site institucional.
